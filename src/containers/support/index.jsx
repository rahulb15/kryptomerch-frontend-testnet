...
import Button from "@ui/button";
import Accordion from "@ui/accordion";
// import { SupportLayout, CategoryGrid } from "@/components/SupportComponents";
import { SupportLayout, CategoryGrid } from "@components/SupportLayout";
import { supportCategories } from "src/data/support";
...
const SupportArea = ({ className, space }) => (
    ...
    >
        <div className="container">
            <div className="row g-6">
                <SupportLayout>
                    <h1>Advice and Answers from the Team</h1>
